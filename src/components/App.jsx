  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div
          className="app__central-container"
          style={{ display: 'flex' }}
        >
                ...
                <div className="app__mobile--group">
                  ...
                  <div className="app__tools-wrapper grid-3">
                    ...
                    <div
                      data-tooltip={
                        helpOn
                          ? 'Sample a color from your drawing (O)'
                          : null
                      }
                    >
                      <EyedropperContainer />
            ...
            <div className="app__right-side">
              <div className="app__mobile--container">
                <div className="app__mobile--group">
                  ...
                  <div
                    data-tooltip={
                      helpOn ? 'Reset the selected frame' : null
                    }
                ...
                <div className="app__mobile--group max-width-container-centered {">
                  <div
                    data-tooltip={
                      helpOn ? 'Size of one tile in px' : null
                    }
                  >
                    <CellSizeContainer />
                  </div>
        ...
        >
          ...
          to cookies being used. Thank you.
          <a
            href="/cookies"
            target="_blank"
